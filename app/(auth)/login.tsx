...
export default function LoginScreen() {
	...
	const handleDemoLogin = (role: "user" | "admin" | "owner") => {
		...
		if (role === "user") credentials.email = "user@example.com";
		else if (role === "admin") credentials.email = "admin@example.com";
		else if (role === "owner") credentials.email = "owner@example.com";
...
const styles = StyleSheet.create({
	...
	demoButtonGroup: {
		marginTop: 16,
		gap: 12, // If you're using React Native < 0.71, use marginBottom instead and wrap each button in a View
	},
	scrollContainer: {
		flexGrow: 1,
		padding: 24,
